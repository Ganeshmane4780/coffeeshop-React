  ...
  return (
    <div>
        ...
        <table className='table'>
            <thead>
                <tr><th>ID</th><th>NAME</th><th>PRODUCT</th><th>QUANTITY</th><th>PRICE</th><th>REMOVE</th></tr>
            </thead>
            <tbody>
                {
                    cart.map((c,i)=>{
            ...
            <tfoot>
                <tr><td colSpan={2}>Subtotal:</td><td>{cart.length} items</td><td>Total:</td><td>₹{total}</td></tr>
            </tfoot>
        </table>
        </Container>
    </div>
